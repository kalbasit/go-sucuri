...
func testdataScanJohnhackedsiteComJson() (*asset, error) {
	...
	info := bindataFileInfo{name: "testdata/scan-johnhackedsite.com.json", size: 5263, mode: os.FileMode(420), modTime: time.Unix(1516303104, 0)}
...
func testdataScanGoogleComJson() (*asset, error) {
	...
	info := bindataFileInfo{name: "testdata/scan-google.com.json", size: 2638, mode: os.FileMode(420), modTime: time.Unix(1516303162, 0)}
	a := &asset{bytes: bytes, info: info}
	return a, nil
}
